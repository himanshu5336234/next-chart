...
type Props = {varient:string|null; options: any[]; placeholder: string; handleChange: () => void; label: string; value: number | string };
const Dropdown = ({varient="primary", label, value, handleChange, options, placeholder }: Props) => {
